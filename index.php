...
<section class="ts-adventure-section">
    ...
    <div class="container">
        ...
        <h6>The ultimate treasures of unforgettable experiences await here. You will find yourself in love as you set
            foot in India.</h6>
            ...
            <div class="col col-12 col-md-6">
                ...
                <div class="ts-who-are-content">
                    ...
                    <div class="ts-section-heading">
                        ...
                        <p class="ts-section-description">We give you, the guest, the power to select or create your
                            itinerary. Yes, at Indian Holiday, you can choose any of our inbound tours & outbound tours
                            accross India & International OR add your inputs to the existing tours and create a fresh,
                            brand new tour yourself, tailor-made to your needs. Our tagline sums it up perfectly –
                            Holiday your way with us.</p>
                        ...
                        <p class="ts-section-description">Our main focuses are - Individual travellers, Groups of
                            ...
                            birthdays) or just about any kind groups travelling and cruising.</p>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col col-12 col-md-6 col-lg-5">
                    ...
                    <div class="ts-update-content">
                        ...
                        <a href="single-blog.php?blog_id=<?= $blog[$blog_count]->entry_id ?>" target="_blank"
                            class="ts-update-title"><?= $blog[$blog_count]->title ?></a>
            ...
            <div class="col col-12 col-md-6 col-lg-5">
                ...
                <ul class="ts-contact-info-list">
                    ...
                    <li class="ts-contact-info-item">
                        ...
                        <span
                            class="ts-contact-info-link"><?= $cached_array[0]->company_profile_data[0]->address ?></span>
                    ...
                    <li class="ts-contact-info-item">
                        ...
                        <span
                            class="ts-contact-info-link"><?= $cached_array[0]->cms_data[0]->header_strip_note ?></span>
